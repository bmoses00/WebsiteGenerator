...
async function v3(message, folder_name = 'chat-create-react-app') {
    ...
    console.log(process.cwd(), componentsDir);
...
function write_root(component_name, folder_name) {
    app_implementation = `
...
async function create_component(expanded_task, component_name, JSON_hierarchy, previous_component_implementation, folder_name) {
    ...
    for (let child of children) {
        create_component(expanded_task, child, JSON_hierarchy, component_implementation, folder_name);
    }
